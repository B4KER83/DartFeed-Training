...
(function (global) {
  ...
  StateMachine.prototype._runArmed = function (gray, frameStable, dt, cfg, roi) {
    ...
    if (!watchingRemovalOnly && areaVsEmpty > this._lastConfirmedAreaVsEmpty + cfg.MIN_CHANGE_AREA * 0.5) {
      ...
      this._captureDart(n, gray, stableStabilityMs, largest, cfg, newDartsCount);
      return;
    }
  ...
  StateMachine.prototype._captureDart = function (n, gray, stabilityMs, blob, cfg, newDartsCount) {
    var self = this;
