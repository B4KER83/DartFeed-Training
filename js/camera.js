...
(function (global) {
  ...
  // Highest practical resolution: ask for a large ideal size and let the
  // browser/device clamp to whatever it actually supports, then report the
  // ACHIEVED resolution back to the caller (never assumed).
